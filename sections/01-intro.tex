...
field protocol of \cref{sec:field}.
...
the model), empirical claims (measured in the simulation, scoped to it), hypotheses
(labeled), and proposals (labeled). No empirical statement in this paper refers to a
real organization.
