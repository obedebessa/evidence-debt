...
investigation, recovery, litigation): the policy incurs effort, may accept an error,
or may abstain. Physical irrecoverability is the separate terminal evidence state.
Under a sound exhaustive policy, abstention coincides with this boundary; a
conservative policy may abstain earlier, while an unsound or aggressive policy may
instead return $W$. Boxes name the constructs formalized in \cref{sec:definitions}.}
\label{fig:lifecycle}
\end{figure}
